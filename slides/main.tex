	...
	\section{Method: 2SDS}
		...
		\subsection{Data selection}
			...
			\begin{frame}{Data selection}
				...
				\begin{itemize}
					\item \textbf{Data smoothing}: Filter all the data noise by using a weighted average pooling filter.\\
					\item \textbf{Data selection}: Merge the selected frames into a single frame.
				\end{itemize}
